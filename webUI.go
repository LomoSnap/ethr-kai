// this file contains ./static folder all files. for one executable file release.
package main
...
<script type="text/javascript">
    // gauge.js, This version modified by karminski. The donut style gauge has been changed. 
    (function () {
        ...
        BaseDonut = (function (superClass) {
            ...
            BaseDonut.prototype.getAngle = function (value) {
                return ((value - this.minValue) / (this.maxValue - this.minValue)) * (this.options.angle * Math.PI)
                // return (this.options.angle) * Math.PI + ((value - this.minValue) / (this.maxValue - this.minValue)) * ((2 + this.options.angle) - (1 - this.options.angle)) * Math.PI;
            };
            ...
            BaseDonut.prototype.render = function () {
                ...
                this.ctx.beginPath();
                // total value
                this.ctx.arc(w, h, this.radius, 0, this.options.angle * Math.PI, false);
                this.ctx.lineWidth = this.lineWidth;
                ...
                // current value
                this.ctx.beginPath();
                this.ctx.arc(w, h, this.radius, 0, displayedAngle, false);
        ...
        Donut = (function (superClass) {
            ...
            Donut.prototype.setOptions = function (options) {
                ...
                // comment this for disable shadow
...
#gauge-panel-text{
    ...
    border-radius: 0.5em;
    font-size: 1.3em;
    position: absolute; top: 1.2em; left: 2em; right: 0;
...
#gauge-1-text{
    ...
    width: 5em;
    color:#67B7DC;
    position: absolute; top: 6.5em; left: 11.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
...
#gauge-2-text{
    ...
    width: 5em;
    color:#6794DC;
    position: absolute; top: 6.5em; left: 30.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
}
...
#gauge-3-1{
    position: absolute; top: 4.76em; left: 38.84em; right: 0;
}

#gauge-3-2{
    position: absolute; top: 4.76em; left: 38.8em; right: 0;
}

#gauge-3-desc{
    color: #CBCBCB;
    position: absolute; top: 5.96em; left: 86.7em; right: 0;
    font-size: 0.5em;
    font-family: 'Consolas', sans-serif;
    width:120px;
...
#gauge-3-1-desc{
    color: #CBCBCB;
    position: absolute; top: 6.9em; left: 87.84em; right: 0;
    font-size: 0.5em;
    font-family: 'Consolas', sans-serif;
    width:120px;
    transform:rotate(-50deg);
...
#gauge-3-2-desc{
    color: #CBCBCB;
    position: absolute; top: 7.8em; left: 89em; right: 0;
    font-size: 0.5em;
    font-family: 'Consolas', sans-serif;
    width:120px;
    transform:rotate(-50deg);
...
#gauge-3-text{
    ...
    width: 5em;
    color:#6771DC;
    position: absolute; top: 6.5em; left: 49.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
}
...
#gauge-4-text{
    ...
    width: 5em;
    color:#C767DC;
    position: absolute; top: 6.5em; left: 68.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
}
...
#gauge-5-text{
    ...
    width: 5em;
    color:#67B7DC;
    position: absolute; top: 19em; left: 11.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
...
#gauge-6-text{
    ...
    width: 5em;
    color:#6794DC;
    position: absolute; top: 19em; left: 30.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
}
...
#gauge-7-text{
    ...
    width: 5em;
    color:#6771DC;
    position: absolute; top: 19em; left: 49.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
}
...
#gauge-8-text{
    ...
    width: 5em;
    color:#8067DC;
    position: absolute; top: 19em; left: 68.6em; right: 0;
    font-family: 'Consolas', sans-serif;
    font-size: 1em;
}
...
#chart-panel-text{
    ...
    border-radius: 0.5em;
    font-size: 1.3em;
    position: absolute; top: 13.8em; left: 2em; right: 0;
    background-color: #FFFFFF;
    text-align: center;
    color: #AAAAAA;
    font-family: 'Consolas', sans-serif;
...
#info-panel-text{
    ...
    border-radius: 0.5em;
    font-size: 1.3em;
    position: absolute; top: 46.6em; left: 2em; right: 0;
    font-family: 'Consolas', sans-serif;
    background-color: #FFFFFF;
    text-align: center;
    color: #AAAAAA;
...
#info-panel::-webkit-scrollbar-thumb {/*滚动条里面小方块*/
    border-radius: 0.2em;
    background: #AAAAAA;
}
